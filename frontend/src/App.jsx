...
class App extends Component {
    state = { authenticated: false, user: null, userID: null };
    ...
    render() {
        // Retrieve role and ID from local storage (make sure they are stored during login)
                ...
                <div>
                    ...
                    <Routes>
                        ...
                        <Route path="/login" element={
                            this.state.authenticated ? <Navigate to={redirectPath} /> : <Login onLoginSuccess={this.handleLoginSuccess} />
                        } />
                        ...
                        <Route path="/doctor/:id" element={this.state.authenticated ? <DoctorProfile /> : <Login onLoginSuccess={this.handleLoginSuccess} />} />
                    </Routes>
                </div>
            </Router>
        );
